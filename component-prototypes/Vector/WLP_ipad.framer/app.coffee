...
pageComp = new PageComponent #Need a nested pageComponent for section scroll
	...
	height: IntelliStream_App.height
# 	width: Framer.Device.screen.width
# 	height: Framer.Device.screen.height
# 	height: Framer.Device.screen.height - headerBar.height - tab.height - footerBar.height
	originY: 0
...
createScrollView = (num, parent) ->
	for i in [0...num]
		pageCompSection = new Layer
			...
			name: scrollBarDescriptions[i]
			image: "images/page_placeholders/WLP/" + i + ".png"
			width: IntelliStream_App.width
