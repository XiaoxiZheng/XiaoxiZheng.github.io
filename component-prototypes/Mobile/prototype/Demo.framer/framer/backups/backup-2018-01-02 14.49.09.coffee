...
banner = m.Banner
  title:"Decrease WHP to 321 psig"
  message:"Potentially increase your production by 332 std/d."
  animated:true
 
 Utils.delay 1.5, -> banner1 = m.Banner
  title:"Decrease WHP to 123 psig"
  message:"Potentially increase your production by 332 std/d."
  animated:true
#Toast Messages
showSnackBar = false
...
notificationsView = new ScrollComponent
	...
	height: m.device.height
	backgroundColor: blackBlue
notification_content = new Layer
...
loadTable = (table, superLayer) ->
	...
	card = () ->
		...
		layer.on Events.Click, ->
			...
			view.constraints = {top:0, bottom:0, leading:0, trailing:0}
...
m.layout.set()
# loadTable("home", home)
# loadTable("notificationsView", notificationsView)
