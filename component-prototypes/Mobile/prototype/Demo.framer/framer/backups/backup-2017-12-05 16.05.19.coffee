...
bhge_logo = new Layer
	parent: headerBar
	width: 135, height: 50
	y: Align.center, x:300
	image: "images/bhge-logo.png"

bhge_logo.bringToFront()
...
# print bar.actions["search"].on Events.TouchEnd, ->
# 	print "toggled search"
# Throw snackbars(toast message)
showSnackBar = false
...
# 	if showSnackBar == false
# 		snack = new m.SnackBar text:"Account Setting"
# 		showSnackBar = true
# 		Utils.delay 1, -> showSnackBar = false
