...
Echart_container = 
	...
	html: '<div id="EchartContainer";"></div>'
Echart_container.ignoreEvents = false

# create a chart with eCharts
mycharts = echarts.init(document.getElementById('EchartContainer'))
      ...
      }
      {
        ...
        children: [
          ...
          }
          {
            name: 'Grape'
            value: 1
            itemStyle: color: '#aeb92c'
          }
          {
            name: 'Apple'
            value: 1
            itemStyle: color: '#4eb849'
          }
          {
            name: 'Peach'
            value: 1
            itemStyle: color: '#f68a5c'
          }
          {
            name: 'Pear'
            value: 1
            itemStyle: color: '#baa635'
          }
        ]
      }
      {
        ...
        children: [
          ...
          }
          {
            name: 'Orange'
            value: 1
            itemStyle: color: '#e2631e'
          }
          {
            name: 'Lemon'
            value: 1
            itemStyle: color: '#fde404'
          }
          {
            name: 'Lime'
            value: 1
            itemStyle: color: '#7eb138'
          }
        ]
      }
    ]
        ...
        children: [
          {
            name: 'Winey'
            value: 1
            itemStyle: color: '#8f1c53'
          }
          {
            name: 'Whiskey'
            value: 1
            itemStyle: color: '#b34039'
          }
          {
            name: 'Fremented'
            value: 1
        ...
        children: [
          {
            name: 'Bitter'
            value: 1
            itemStyle: color: '#80a89d'
          }
          {
            name: 'Salty'
            value: 1
            itemStyle: color: '#def2fd'
          }
          {
            name: 'Medicinal'
            value: 1
          ...
          }
          {
            name: 'Skunky'
            value: 1
            itemStyle: color: '#5e777b'
          }
          {
            name: 'Rubber'
            value: 1
            itemStyle: color: '#120c0c'
          }
        ]
      }
    ]
        ...
        children: [
          {
            name: 'Acrid'
            value: 1
            itemStyle: color: '#b9a449'
          }
          {
            name: 'Ashy'
            value: 1
            itemStyle: color: '#899893'
          }
          {
            name: 'Smoky'
            value: 1
            itemStyle: color: '#a1743b'
          }
          {
            name: 'Brown, Roast'
            value: 1
        ...
        children: [
          {
            name: 'Grain'
            value: 1
            itemStyle: color: '#b7906f'
          }
          {
            name: 'Malt'
            value: 1
            itemStyle: color: '#eb9d5f'
          }
        ]
      }
    ]
      ...
      }
      {
        ...
        children: [
          ...
          }
          {
            name: 'Cinnamon'
            value: 1
            itemStyle: color: '#e5762e'
          }
          {
            name: 'Clove'
            value: 1
            itemStyle: color: '#a16c5a'
          }
        ]
      }
    ]
  ...
  }
  {
    ...
    children: [
      ...
      }
      {
        name: 'Vanilla'
        value: 1
        itemStyle: color: '#f89a80'
      }
      {
        name: 'Vanillin'
        value: 1
        itemStyle: color: '#f37674'
      }
      {
        name: 'Overall Sweet'
        value: 1
        itemStyle: color: '#e75b68'
      }
      {
        name: 'Sweet Aromatics'
        value: 1
        itemStyle: color: '#d0545f'
      }
    ]
  }
]
