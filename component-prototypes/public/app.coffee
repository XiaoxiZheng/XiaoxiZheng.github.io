...
document.title = "AI Factory Demos"
...
# print Content_frame.y 

Content_frame_scroll_comp = new ScrollComponent
...
Content_frame.y-=150	
Content_frame.parent = Content_frame_scroll_comp.content
# 
# Content_frame_scroll_comp.contentInset =
# 	top: 20
# 	right: 0
# 	bottom: 20
# 	left: 0
...
createHorizontalCards = (cardTitleName, cardContentJson) ->
	...
	left_arrow = new Layer
		...
		x: 0 
		opacity: 0.5
		image: "images/left_arrow.svg"
	right_arrow = new Layer
		parent: arrowsContainer
		color: "white"
		width: 13
		height: 13
		x: left_arrow.x + left_arrow.width + 40 
		image: "images/right_arrow.svg"
