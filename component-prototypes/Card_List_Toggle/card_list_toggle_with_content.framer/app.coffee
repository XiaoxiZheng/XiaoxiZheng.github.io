...
#Creating custom gridlines
cardListWireframe = new CardListView
	xStart: 255
	yStart: 190
	cardWidth: 330
	cardHeight: 330
...
list_toggle.onClick ->
	notification_cardListView.hidecards()
	Utils.delay 0.1, ->
		cardListWireframe.listView(true) #animate wireframe
		notification_cardListView.listView(false) #dont animate content
		Utils.delay 0.3, ->
			notification_cardListView.showCards()

card_toggle.onClick ->
	notification_cardListView.hidecards()
	Utils.delay 0.1, ->
		cardListWireframe.cardView(true) #animate wireframe
		notification_cardListView.cardView(false)
		Utils.delay 0.3, ->
			notification_cardListView.showCards()
